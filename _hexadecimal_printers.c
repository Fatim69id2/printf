...
/**
 * print_h_l - takes an unsigned int and prints
 * it in lowercase hex notation
 * @args: arguments
 *
 * Return: number of digits printed
 */
int print_h_l(va_list args)
{
	return (print_hex(va_arg(args, unsigned int), 0));
}

/**
 * print_h_u - takes an unsigned int and prints it in
 * uppercase hex
 * @args: arguments
 *
 * Return: the number of digits printed
 */
int print_h_u(va_list args)
{
	return (print_hex(va_arg(args, unsigned int), 1));
}

/**
 * print_adresse - prints an address
 * @args: the arguments
 *
 * Return: the number of chars to print
 */
int print_adresse(va_list args)
{
	int cpt = 0;
	unsigned int a[16];
	unsigned int i, sum;
